...
void input_handler(int input, /* char input[],*/ Record records[]){
  ...
  switch(input) {
    ...
    case 3 : delete_a_data(records); break;
    case 4 : delete_all(records); break;
    case 5 : print_all_records(records); break;
    case 6 : print_specific_records(records); break;
    case 7 : print_multi_records(records); break;
    case 8 : save_a_data(records); break;
    case 9 : sort_in_date(records); break;
    case 10 : defragment(records); break;
    case 11 : display_stats(records); break;
...
void display_menu(){
  ...
  printf(" 4. Delete all cars\n");
	printf(" 5. Print all cars\n");
  printf(" 6. Print specific car\n");
  printf(" 7. Print specific number of cars\n");
  printf(" 8. Save data to the text file\n");
  printf(" 9. Sort data in manufacture date\n");
